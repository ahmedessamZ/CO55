...
@section('content')
    ...
    <div class="container-fluid p-0 m-0">
        ...
        <div class="row">
            <div class="col">
                <a href="{{ url('admin/job/create') }}" class="btn btn-success btn-sm" title="Add User">
            ...
            <table class="table table-striped table-bordered">
                ...
                @foreach($jobs as $item)
                    <tr class="text-center">
                        <td>{{ $item->title }}</td>
                        <td>
                            <a href="{{ url('admin/job/' . $item->id) }}" title="View">
                           <i style="color: #000000" class="fa-regular fa-eye"></i>
                            </a>
                            <a href="{{ url('admin/job/' . $item->id . '/edit') }}" title="Edit">
