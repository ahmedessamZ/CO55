...
@section('content')
    ...
    <div class="container-fluid p-0 m-0">
        ...
        <div class="row">
            <div class="col">
                <a href="{{ url('admin/link/create') }}" class="btn btn-success btn-sm" title="Add User">
            ...
            <table class="table table-striped table-bordered">
                ...
                @foreach($links as $item)
                    <tr class="text-center">
                        ...
                        <td>{{ $item->body }}</td>
                        <td>
                            <img style="background: #7a8793; padding: 5px" src="{{asset('images/'.$item->logo)}}"
                                 width="30px" height="30px">
                        </td>
                        <td>
                            <a href="{{ url('admin/link/' . $item->id) }}" title="View">
                           <i style="color: #000000" class="fa-regular fa-eye"></i>
                            </a>
                            <a href="{{ url('admin/link/' . $item->id . '/edit') }}" title="Edit">
                                 <i style="color: #000000" class="fa-regular fa-pen-to-square"></i>
                            </a>
                            <form method="POST" action="{{ url('admin/link/' . $item->id) }}"
