...
@section('content')
    ...
    <div class="container-fluid p-0">
        ...
        <div class="col-12 p-0">
            <form action="{{ url('admin/amenity/'.$amenity->id) }}" method="post" enctype="multipart/form-data">
                @method("PATCH")
                @csrf
                <input type="hidden" name="id" value="{{$amenity->id}}" id="id"/>
                ...
                <div class="row m-0 justify-content-center p-2">
                    ...
                    <div class="col-7 px-5 py-3">
                        ...
                        <input type="text" class="form-control" placeholder="Enter title"
                               name="title" value="{{$amenity->title}}">
