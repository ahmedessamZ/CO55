...
@section('content')
    ...
    <div class="container-fluid p-0 m-0">
        ...
        <div class="row">
            <div class="col">
                <a href="{{ url('admin/amenity/create') }}" class="btn btn-success btn-sm" title="Add">
            ...
            <table class="table table-striped table-bordered">
                ...
                @foreach($amenities as $item)
                    <tr class="text-center">
                        ...
                        <td>
                            <a href="{{ url('admin/amenity/' . $item->id) }}" title="View">
                           <i style="color: #000000" class="fa-regular fa-eye"></i>
                            </a>
                            <a href="{{ url('admin/amenity/' . $item->id . '/edit') }}" title="Edit">
                                 <i style="color: #000000" class="fa-regular fa-pen-to-square"></i>
                            </a>
                            <form method="POST" action="{{ url('admin/amenity/' . $item->id) }}"
