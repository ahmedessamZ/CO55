...
<div class="container">
    ...
    <div class="d-flex justify-content-center">
        <div class="position-relative my-5">
            <h1 class="head-h-h">MAKE AN INQUIRY</h1>
    ...
    <div class="w-100 h-100 py-5 my-5 contact-us-bg">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-10 col-md-8 col-lg-6">
                <h2 class="text-white text-center pb-3">INQUIRY INFORMATION</h2>
                <div class="mb-2 why-content border-small-line-white"></div>
                <form action="{{ url('make-an-inquiry') }}" method="post" class="text-white" enctype="multipart/form-data">
                    @csrf

                    <div class="form-group">
                        <label class="why-content" for="location_id">Location</label>
                        <select class="form-control textarea text-white" name="location_id">
                            <option class="text-dark" value="">Location</option>
                    ...
                    <div class="form-group">
                        <label class="why-content" for="service_id">Service</label>
                        <select class="form-control textarea text-white" name="service_id">
                            <option class="text-dark" value="">Service</option>
